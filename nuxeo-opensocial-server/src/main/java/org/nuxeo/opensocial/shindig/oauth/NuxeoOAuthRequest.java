...
public class NuxeoOAuthRequest extends OAuthRequest {
	...
	private boolean handleProtocolException(NXOAuthProtocolException pe, int attempts)
	 ...
	 */
	private HttpResponseBuilder attemptFetch() throws OAuthRequestException, NXOAuthProtocolException {
	  if (needApproval()) {
	...
	private void fetchRequestToken() throws OAuthRequestException, NXOAuthProtocolException {
	...
	private OAuthMessage sendOAuthMessage(HttpRequest request)
	    throws OAuthRequestException, NXOAuthProtocolException {
	 ...
	 */
	private void exchangeRequestToken() throws OAuthRequestException, NXOAuthProtocolException {
	 ...
	 */
	private HttpResponseBuilder fetchData() throws OAuthRequestException, NXOAuthProtocolException {
